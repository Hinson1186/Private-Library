...
export const initialBooks: Book[] = [
  ...
  createBook(
    "關於我在無意間被隔壁的天使變成廢柴這件事 1",
    "佐伯さん",
    "關於我在無意間被隔壁的天使變成廢柴這件事",
    "5e6bed85-d431-4e87-8a3e-ea5776a16d0b",
    "https://www.tongli.com.tw/ComicImages/Images/NY0018/NY0018001/NY0018001.jpg"
  ),
  createBook(
    "我想成為影之強者！ 2",
    "逢澤大介",
  ...
  ...createSeries({
    ...
    category: "出租女友",
    idBase: "rent-gf",
    volumes: [1, 2, 3, 4, 5, 6, 10, 11, 22, 23, 24, 25, 26],
    covers: {
